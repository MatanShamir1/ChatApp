...
- int the second button you can upload record from the computer.
- int third button we also add ,dispite in wasn't requirment , abillty to picature image from the screen.
**features included:**
