...
let contactList = [
    { name: "Itamar",  messages: [['what is up?',"text"]], new: 2, source: img1 },
    { name: "Coral",  messages: [['what is up?',"text"]], new: 1, source: img2 },
    { name: "Amit",  messages: [['what is up?',"text"]] , new: 1, source: img3 },
]
